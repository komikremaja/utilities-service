...
public class UtilitiesImpl {
    ...
    public Response inquiryDataAccountBank(InquiryAccountBankRequest request) throws Exception {
        ...
        if((request.getAccountType() != null && !request.getAccountType().isEmpty()) && (request.getBankName() !=null && !request.getBankName().isEmpty()) ){
            ...
            accountDb = utilitiesAccountRepo.findByAccountNumberAndCurrencyType(request.getAccountNumber(), request.getAccountType());
        }else if(request.getBankName() !=null && !request.getBankName().isEmpty() ){
            accountDb = utilitiesAccountRepo.findByAccountNumberAndBankName(request.getAccountNumber(), request.getBankName());
        }else{
    ...
    public Response transfer(TransferRequest request) throws Exception {
        ...
        if (!sourceAccountData.getCurrencyType().equalsIgnoreCase(tagihanPembayaran.getCurrency())) {
            throw new BadRequestException("Tipe mata uang rekening tidak sesuai dengan currency yang di transaksikan");
        }
        ...
        // if (bankCode.equalsIgnoreCase("001") && !sourceAccountData.getBankName().equalsIgnoreCase("BCA")) {
        //     throw new BadRequestException("Va Number tidak sesuai");
        // } else if (bankCode.equalsIgnoreCase("002") && !sourceAccountData.getBankName().equalsIgnoreCase("BRI")) {
        //     throw new BadRequestException("Va Number tidak sesuai");
        // }else if (bankCode.equalsIgnoreCase("003") && !sourceAccountData.getBankName().equalsIgnoreCase("Mandiri")) {
        //     throw new BadRequestException("Va Number tidak sesuai");
        // }
        ...
        if(sourceAccountData.getBankName().equalsIgnoreCase("BCA") && sourceAccountData.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("66603268781");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BCA") && sourceAccountData.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("66604288745");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BCA") && sourceAccountData.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("66604222678");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BCA") && sourceAccountData.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("66604222670");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BCA") && sourceAccountData.getCurrencyType().equalsIgnoreCase("EUR")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("66604222672");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BRI") && sourceAccountData.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("3330879552468");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BRI") && sourceAccountData.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("3330879552462");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BRI") && sourceAccountData.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("3330879552461");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BRI") && sourceAccountData.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("3330879552465");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("BRI") && sourceAccountData.getCurrencyType().equalsIgnoreCase("EUR")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("3330879552464");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("Mandiri") && sourceAccountData.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("777012544678521");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("Mandiri") && sourceAccountData.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("777012544678522");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("Mandiri") && sourceAccountData.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("777012544678523");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("Mandiri") && sourceAccountData.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeCredit = utilitiesAccountRepo.findByAccountNumber("777012544678524");
        }else if(sourceAccountData.getBankName().equalsIgnoreCase("Mandiri") && sourceAccountData.getCurrencyType().equalsIgnoreCase("EUR")){
        ...
        UtilitiesAccount destinationAccount = utilitiesAccountRepo.findByAccountNumber(tagihanPembayaran.getDestinationAccount());
        if(destinationAccount.getBankName().equalsIgnoreCase("BCA") && destinationAccount.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("66603268781");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BCA") && destinationAccount.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("66604288745");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BCA") && destinationAccount.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("66604222678");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BCA") && destinationAccount.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("66604222670");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BCA") && destinationAccount.getCurrencyType().equalsIgnoreCase("EUR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("66604222672");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BRI") && destinationAccount.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("3330879552468");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BRI") && destinationAccount.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("3330879552462");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BRI") && destinationAccount.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("3330879552461");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BRI") && destinationAccount.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("3330879552465");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("BRI") && destinationAccount.getCurrencyType().equalsIgnoreCase("EUR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("3330879552464");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("Mandiri") && destinationAccount.getCurrencyType().equalsIgnoreCase("IDR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("777012544678521");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("Mandiri") && destinationAccount.getCurrencyType().equalsIgnoreCase("USD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("777012544678522");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("Mandiri") && destinationAccount.getCurrencyType().equalsIgnoreCase("SGD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("777012544678523");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("Mandiri") && destinationAccount.getCurrencyType().equalsIgnoreCase("AUD")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("777012544678524");
        }else if(destinationAccount.getBankName().equalsIgnoreCase("Mandiri") && destinationAccount.getCurrencyType().equalsIgnoreCase("EUR")){
            accountXchangeDebit = utilitiesAccountRepo.findByAccountNumber("777012544678525");
        }
        //debit to nomor rekening xchangeDebit
        accountXchangeDebit.setAmount(accountXchangeDebit.getAmount().subtract(tagihanPembayaran.getTotalAmount()));

        //credit to nomor rekening destination
        destinationAccount.setAmount(destinationAccount.getAmount().add(tagihanPembayaran.getTotalAmount()));
